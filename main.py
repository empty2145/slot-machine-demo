    ...
    while True:
        ...
        if amount.isdigit():
            ...
            if MIN_BET <= amount <= MAX_BET:
                ...
                print(f"Amount must be between ${MIN_BET} - ${MAX_BET}. Please try again.")
        else:
            print("Amount must be a number. Please try again.")
    return amount
...
def spin(balance):
    ...
    while True:
        ...
        if total_bet > balance:
            print(f"You don't have enough money to bet on this line, your current balance is ${balance}")
        else:
            break
